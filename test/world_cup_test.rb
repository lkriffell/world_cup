...
class WorldCupTest < Minitest::Test
  def test_world_cup_has_attributes
  ...
  def test_all_players_by_position
    ...
    croatia.add_player(vida)
    world_cup = WorldCup.new(2018, [france, croatia])
    all_players_by_position = {"forward"=>[mbappe],"midfielder"=>[pogba, modric],"defender"=>[vida]}

    assert_equal all_players_by_position, world_cup.all_players_by_position
  end
end
